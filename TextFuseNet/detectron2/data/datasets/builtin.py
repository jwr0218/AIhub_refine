...
_PREDEFINED_SPLITS_COCO["coco"] = {
    ...
    "aihub_korean_train" : ("datasets_aihub/training/images","datasets_aihub/training/train.json"),
    "aihub_korean_validation" : ("datasets_aihub/validation/images","datasets_aihub/validation/validation.json")
